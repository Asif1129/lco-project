    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setupFirebaseAuth();
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LoginSignup.this,Choice_new.class));
            }
        });
    }
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if(user.isEmailVerified()){
                        Toasty.success(LoginSignup.this, "Authenticated with: " + user.getEmail(), Toast.LENGTH_SHORT, true).show();
                       // Toast.makeText(LoginSignup.this, "Authenticated with: " + user.getEmail(), Toast.LENGTH_SHORT).show();
                        ...
                        Toasty.info(LoginSignup.this, "Email is not Verified\nCheck your Inbox", Toast.LENGTH_SHORT, true).show();
